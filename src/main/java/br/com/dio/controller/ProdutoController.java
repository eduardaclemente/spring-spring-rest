...
@RestController
@RequestMapping(value = "/produto") // daqui pra baixo tudo é produto
public class ProdutoController {

	@Autowired
	private ProdutoService service;

	@PostMapping(value = "/save") // MANDANDO DADOS PRA SALVAR, melhor que chamar 2RequestMapping e ter que informar qual metódo
